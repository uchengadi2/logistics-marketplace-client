...
import { fetchPartialPayments } from "../../actions";
import DataGridContainer from "../DataGridContainer";

class PaymentPartialList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchPartialPayments(this.props.token, this.props.status);
  }
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/payments/partial/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <CancelRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/payments/partial/cancel/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <AssignmentIcon
              ...
              onClick={() => [
                ...
                history.push(`/payments/partial/assign/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/payments/partial/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
...
const mapStateToProps = (state) => {
  ...
  return { payments: Object.values(state.paymentPartial) };
};

export default connect(mapStateToProps, { fetchPartialPayments })(
  PaymentPartialList
);
