...
import CountryFormContainer from "../utilities/countries/CountryFormContainer";
...
function CountryLayout({ token, userId }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        <Grid item className={classes.headerContainer}>
          <Toolbar disableGutters className={classes.toolbar}>
            <Button
              ...
              onClick={() => [
                setOpen(true),
                history.push("/utilities/countries/new"),
              ]}
            >
              Add Country
            </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <CountryList token={token} userId={userId} />
        </Grid>
      </Grid>
      <Dialog
        //style={{ zIndex: 1302 }}
