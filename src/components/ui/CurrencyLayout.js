...
import CurrencyList from "./../utilities/currencies/CurrencyList";
import CurrencyFormContainer from "./../utilities/currencies/CurrencyFormContainer";
  ...
  return (
    ...
    >
      ...
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/utilities/currencies")]}
      >
        <DialogContent>
